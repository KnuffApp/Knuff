...
* Get the device token automatically; forget about manually retrieving the device token through logging or similar techniques. Even more useful when not in sandbox mode (requires https://github.com/KnuffApp/Knuff-Framework)
